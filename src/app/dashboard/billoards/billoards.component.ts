...
import {BillboardService} from "../services/blloard.service";
@Component({
  selector: 'app-billoards',
  templateUrl: './billoards.component.html',
  styleUrls: ['./billoards.component.css']
})
export class BilloardsComponent {
